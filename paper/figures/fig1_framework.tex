% fig1_framework.tex - top-tier framework diagram (TikZ vector, semantic colors + icons + protocol bar)
% Structure follows Methodology: data sources -> features -> models -> risk control -> decision
\begin{figure*}[tbp]
\centering
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[
  font=\scriptsize,
  % ===== colors (semantic, grayscale-friendly) =====
...
% ===== data-source icons (hand-drawn mini figures) =====
...
% decision -> protocol bar (dashed: evaluation loop)
