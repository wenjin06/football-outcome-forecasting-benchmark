...
\centering
\small
\caption{Overall performance on the held-out test season (1,104 matches). The LLM parsed 100\% of matches at a cost of \$0.55. Bootstrap 95\% confidence intervals are reported in the text.}
\label{tab:main}
\resizebox{\textwidth}{!}{
