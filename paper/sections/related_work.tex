...
inefficiency. Our work follows this prescription, and additionally
reports the opening-to-closing drift experiment as a direct test of
market efficiency on our data.
...
difficult to audit. Our setting is deliberately simpler: the LLM
...
\subsection{Gaps}
Three gaps motivate our design. (i)~Most evaluations lack a
...
hand-crafted scores whose empirical validity is not tested. We
address all three with a conservative, fully specified evaluation and
with empirically validated uncertainty signals.
