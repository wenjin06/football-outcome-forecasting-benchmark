...
components are detailed below. We use 11,811 league matches from the English Premier League (E0),
Spanish La Liga (SP1), German Bundesliga (D1), Italian Serie A (I1),
and French Ligue 1 (F1), covering the 2019/20--2025/26 seasons
(2025/26 is incomplete, ending 2026-02-12; we report this honestly).
...
format. We additionally crawl per-match expected goals (xG, xGA,
npxG, npxGA), pressing intensity (PPDA), and deep progression from
Understat for all five leagues and all seven seasons
...
\emph{more} complex (a direction error), we define
\[
...
\]
with default weights $(0.4, 0.3, 0.15, 0.15)$; $p_{\max}$ is the
model's maximum predicted probability and $C$ the multi-sample
consistency (1 for deterministic models). Risk tiers are
